...
#SBATCH --output=/scratch/users/cdonnat/convex_clustering/HC_dev/experiments/logs/khan.out
#SBATCH --error=/scratch/users/cdonnat/convex_clustering/HC_dev/experiments/logs/khan.err
