#!/bin/bash
#
#SBATCH --job-name=digits_submit$1_$2
#SBATCH --output=/scratch/users/cdonnat/convex_clustering/HC_dev/experiments/logs/digits$1_$2.out
#SBATCH --error=/scratch/users/cdonnat/convex_clustering/HC_dev/experiments/logs/digits$1_$2.err
